       ...
       always {
        ...
        stage('Deploy To Test') {
            steps {
               ...
               deploy adapters: [tomcat8(url: 'http://34.72.154.124:8080/', credentialsId: 'tomcat', path: '' )], contextPath: '/QAWebapp', war: '**/*.war'
            
        }
            post {
       always {
           jiraSendDeploymentInfo environmentId: 'http://34.72.154.124:8080/', environmentName: 'http://34.72.154.124:8080/', environmentType: 'testing', issueKeys: ['DEV-4'], serviceIds: [''], site: 'devopssquad13.atlassian.net', state: 'successful'
