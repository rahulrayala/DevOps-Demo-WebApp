pipeline {
    ...
    stages {
        ...
        stage('BuildProject') {
            ...
            post {
       always {
           jiraSendBuildInfo branch: 'DEV-3', site: 'devopssquad13.atlassian.net'
        ...
        stage('DeployToNewTest') {
            steps {
               ...
               // }               
               deploy adapters: [tomcat8(url: 'http://35.224.110.201:8080/', credentialsId: 'tomcat', path: '' )], contextPath: '/QAWebapp', war: '**/*.war'
